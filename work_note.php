    ...
    <div class="left_bar">
      ...
      <div class="main_menu">
        <div class="main_menu_items">
          <div class="search_container">
            ...
            <button type="button" class="button_search" id="button_search">Искать</button type="button">
          </div>
          <button type="button" class="active_notes menu_item"> <img class="svg_icon_menu" src="../svg/active.svg">Активные</button type="button">
          <button type="button" class="active_notes menu_item"> <img class="svg_icon_menu" src="../svg/time.svg">Недавно изменные</button type="button">
        </div>
      </div>
      <div class="left_bar_container">  
        <div class="work_space_bar">
          ...
          <div class="main_notes work_space_item"><img class="svg_icon" src="/svg/all.svg" alt=""> <button type="button" class="folders_btn" id="folders_btn">Все задачи</button type="button"> </div>
          <div class="main_notes work_space_item"><img class="svg_icon" src="/svg/main.svg" alt=""> <button type="button" class="folders_btn" id="folders_btn">Главные задачи</button type="button"> </div>
          <div class="plane_notes work_space_item"><img class="svg_icon" src="/svg/Planning.svg" alt=""><button type="button" class="folders_btn" id="folders_btn">Планируемые задачи</button type="button"> </div>
          <div class="daily_notes work_space_item"><img class="svg_icon" src="/svg/Daily.svg" alt=""><button type="button" class="folders_btn" id="folders_btn">Ежедневные задачи</button type="button"></a></div>
          <div class="side_notes work_space_item"><img class="svg_icon" src="/svg/side.svg" alt=""><button type="button" class="folders_btn" id="folders_btn">Второстепенные задачи</button type="button"></div>
        </div>
        ...
        <div class="exit_logo">
          <form action="../php_vendor/actions/logout.php" method="POST"><button type="submit" class="logout_btn" name="logout_btn" id="logout_btn"></button type="button"></form>
      ...
      <div class="right_bar">
        <div class="navbar_right">
          <div class="navbar_right_items">
            <button type="button" class="open_modal_window" name="open_modal_window" id="open_modal_window">+ Новая доска</button type="button">
        ...
        <div class="modal" id="modal_create_note">
          <div class="modal_box">
            <button type="button" class="modal_close_btn" id="modal_close_btn"> 
            ...
            <h2>Новая доска</h2>
              <div class="form_box">
                <form action="../php_vendor/actions/add_note.php" id="add_note_form" method="POST">
                  ...
                  <div>
                    <button class="create_note_btn" name="create_note_btn" id="create_note_btn" type="submit">Создать доску</button type="button">
                  </div>
                </form>
          </div>
        </div>
